...
class Stylesheet {
  ...
  transformScope(root, rules) {
    ...
    if (rules) {
      ...
      (_this$currConditional4 = this.currConditionalRuleset) === null || _this$currConditional4 === void 0 || _this$currConditional4.addConditionPrecedence(parentConditions, Object.keys(rules).map(bounds => {
        transformedScopeBounds[bounds] = "@scope ".concat(this.transformSelector(bounds.replace(nestingSelectorRegex, root.selector)));
